...
public class ParserSSIM extends AParser {
	 ...
	 * @return String 
	 * @param String: la ligne a parser
	 */
	@Override
	public String parse(String ligne) {
		...
		if (!ligne.isEmpty()) {
			...
			if (!this.resultat.isEmpty()) {
				...
				sb.append(this.resultat.subSequence(
	...
	public Map<String, String> getSSIMResult(String chaine) {
		...
		result.put(APP_EnumPropSSIM.IDENTIFIANT_TRANCHE.toString(), chaine
				.substring(
						...
						APP_enumParserCirculation.POSITION_IDENTIFIANT_TRANCHE
								.getPostionFin()));
		result.put(APP_EnumPropSSIM.RANG_TRONCON.toString(), chaine
				.substring(
		...
		result.put(APP_EnumPropSSIM.DATE_FIN_CIRCULATION.toString(), chaine
				.substring(
						...
						APP_enumParserCirculation.POSITION_DATE_FIN_CIRCU
								.getPostionFin()));
		result.put(APP_EnumPropSSIM.GARE_DEPART.toString(), chaine
				.substring(
						APP_enumParserCirculation.POSITION_ORGINE
								.getPostionDebut(),
						APP_enumParserCirculation.POSITION_ORGINE
								.getPostionFin()));
		result.put(APP_EnumPropSSIM.HEURE_DEPART.toString(), chaine
				.substring(
		...
		result.put(APP_EnumPropSSIM.DIFFERENCE_GMT_DEPART.toString(), chaine
				.substring(
						...
						APP_enumParserCirculation.POSITION_DIFF_GMT_DEPART
								.getPostionFin()));
		result.put(APP_EnumPropSSIM.GARE_ARRIVER .toString(), chaine
				.substring(
		...
		result.put(APP_EnumPropSSIM.HEURE_ARRIVER.toString(), chaine
				.substring(
		...
		result.put(APP_EnumPropSSIM.COMPAGNIE_TRAIN.toString(), chaine
				.substring(
						...
						APP_enumParserCirculation.POSITION_COMPAGNIE_TRAIN
								.getPostionFin()));
		result.put(APP_EnumPropSSIM.NUMERO_TRAIN.toString(), chaine
				.substring(
