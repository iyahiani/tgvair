...
public class IhmManagedBean implements Serializable {
	...
	private static final Logger log = Logger.getLogger(IhmManagedBean.class);
	...
	public String goLogin() {
		...
		if (this.getOriginalURL() == null) {
			this.setOriginalURL(((HttpServletRequest) FacesContext
					.getCurrentInstance().getExternalContext().getRequest())
	...
	public Locale getLocale() {
		if (null == this.locale)
			this.locale = new Locale(FacesContext.getCurrentInstance()
