...
public class UtilisateurDao extends AbstractDao {
	...
	public UtilisateurDataBean getUserByLogin(String login) {
		return (UtilisateurDataBean) this
				.getEntityManager()
				.createQuery(
						"SELECT user FROM UtilisateurDataBean user WHERE user.loginUser = :login")
	...
	public List<UtilisateurDataBean> getAll() {
		return this.getEntityManager().createQuery("FROM UtilisateurDataBean")
				.getResultList();
	}
}